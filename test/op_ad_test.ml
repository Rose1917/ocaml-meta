...
(* let%test "pad_3d"= *) 
(*   let input = ones [|2;5;5|] in *)
(*   print input ~prefix:"input"; *)
(*   let pad_res = pad_3d input 2 in *)
(*   print pad_res ~prefix:"max_res"; *)
(*   diff pad_res; *)
(*   print input ~prefix:"input(after diff)"; *)
(*   print pad_res ~prefix:"max_res(after diff)"; *)
(*   false *)
  
(* let%test "avg_pool3d"= *) 
(*   let input = sequential [|2;4;4|] ~if_grad:false in *)
(*   print input ~prefix:"input"; *)
(*   let max_res = avg_pool3d (pad_3d input 2) [|2;2|] ~stride:2 in *)
(*   print max_res ~prefix:"avg_res"; *)
(*   diff max_res; *)
(*   print input ~prefix:"input(after diff)"; *)
(*   print max_res ~prefix:"avg_res(after diff)"; *)
(*   false *)
